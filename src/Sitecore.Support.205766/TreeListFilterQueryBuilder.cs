...
namespace Sitecore.Support.Shell.Applications.ContentEditor.FieldHelpers
{
  ...
  public class TreeListFilterQueryBuilder
  {
    ...
    ///   The item condition.
    /// </value>
    public virtual string ItemCondition
    {
      get
      {
        return "(contains(',{0},', ',' + @@id + ',') or contains(',{0},', ',' + @@key + ','))";
      }
    }
    ...
    /// </value>
    public virtual string TemplateCondition
    {
      get
      {
        return "(containscaseinsensitive(',{0},', ',' + @@templateid + ',') or contains(',{0},', ',' + @@templatekey + ','))";
      }
    }
    ...
    public virtual string BuildFilterQuery(TreeList treeList)
    {
    ...
    protected virtual void AppendCondition(StringBuilder queryBuilder, string conditionValues, string xPathCondition, bool negativeStatement)
    {
      ...
      #region Sitecore.Support.205766
      if (conditionValues.StartsWith("{"))
      {
        queryBuilder.AppendFormat(xPathCondition, conditionValues);
      }
      else
      {
